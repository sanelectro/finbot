# 📊 FinBot Evaluation Guide - Component 4 Documentation

**Complete guide for running and understanding RAGAs evaluation**
...
PYTHONPATH=. python src/evaluation/ragas_orchestrator.py
```
...
- **🛡️ Guardrails (Component 3)**: `docs/core/GUARDRAILS.md`
...
- `src/evaluation/internal_evaluator.py` - Internal metrics
- `src/evaluation/ragas_orchestrator.py` - Evaluation runner
- `data/evaluation/test_dataset.json` - Test cases
